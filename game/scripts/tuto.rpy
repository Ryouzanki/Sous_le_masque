...
label tuto_sha :
    ...
    ss "Voir des CG et entendres des musiques les débloque dans la galerie."
    ss "Les très bonnes fins débloquent une route bonus qui permet de changer de point de vue."
